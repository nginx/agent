...
type Backoff struct {
	...
	IntialInterval int32 `protobuf:"varint,1,opt,name=intial_interval,json=intialInterval,proto3" json:"intial_interval"`
	// Random value used to create range around next backoff interval
	RandomizationFactor float32 `protobuf:"fixed32,2,opt,name=randomization_factor,json=randomizationFactor,proto3" json:"randomization_factor"`
	// Value to be multiplied with current backoff interval
	Multiplier float32 `protobuf:"fixed32,3,opt,name=multiplier,proto3" json:"multiplier"`
	// Max interval in seconds between two retries
	MaxInterval int32 `protobuf:"varint,4,opt,name=max_interval,json=maxInterval,proto3" json:"max_interval"`
	// Elapsed time in seconds after which backoff stops.
	// It never stops if max_elapsed_time == 0.
	MaxElapsedTime       int32    `protobuf:"varint,5,opt,name=max_elapsed_time,json=maxElapsedTime,proto3" json:"max_elapsed_time"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Backoff) GetIntialInterval() int32 {
	if m != nil {
...
func (m *Backoff) GetRandomizationFactor() float32 {
	if m != nil {
...
func (m *Backoff) GetMultiplier() float32 {
	if m != nil {
		return m.Multiplier
	}
	return 0
...
func (m *Backoff) GetMaxInterval() int32 {
	if m != nil {
...
func (m *Backoff) GetMaxElapsedTime() int32 {
	if m != nil {
...
var fileDescriptor_56ede974c0020f77 = []byte{
	...
	,
}
...
func (m *Backoff) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RandomizationFactor != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.RandomizationFactor))))
		i--
		dAtA[i] = 0x15
	}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IntialInterval |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxInterval |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxElapsedTime |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
