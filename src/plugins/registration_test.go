...
func TestRegistration_Process(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			pluginUnderTest := NewOneTimeRegistration(cfg, binary, env, &proto.Metadata{}, tutils.GetProcesses())
...
func TestRegistration_areDataplaneSoftwareDetailsReady(t *testing.T) {
	...
	pluginUnderTest := NewOneTimeRegistration(conf, nil, tutils.GetMockEnv(), nil, tutils.GetProcesses())
