...
// Validate checks the field values on NGINXPlusConfig with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *NGINXPlusConfig) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on NGINXPlusConfig with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// NGINXPlusConfigMultiError, or nil if none found.
func (m *NGINXPlusConfig) ValidateAll() error {
	return m.validate(true)
}

func (m *NGINXPlusConfig) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return NGINXPlusConfigMultiError(errors)
	}

	return nil
}

// NGINXPlusConfigMultiError is an error wrapping multiple validation errors
// returned by NGINXPlusConfig.ValidateAll() if the designated constraints
// aren't met.
type NGINXPlusConfigMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m NGINXPlusConfigMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m NGINXPlusConfigMultiError) AllErrors() []error { return m }

// NGINXPlusConfigValidationError is the validation error returned by
// NGINXPlusConfig.Validate if the designated constraints aren't met.
type NGINXPlusConfigValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e NGINXPlusConfigValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e NGINXPlusConfigValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e NGINXPlusConfigValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e NGINXPlusConfigValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e NGINXPlusConfigValidationError) ErrorName() string { return "NGINXPlusConfigValidationError" }

// Error satisfies the builtin error interface
func (e NGINXPlusConfigValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sNGINXPlusConfig.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = NGINXPlusConfigValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = NGINXPlusConfigValidationError{}
