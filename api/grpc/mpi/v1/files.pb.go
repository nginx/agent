...
func file_mpi_v1_files_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mpi_v1_files_proto_msgTypes[13].Exporter = func(v any, i int) any {
			switch v := v.(*CertificateMeta); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mpi_v1_files_proto_msgTypes[14].Exporter = func(v any, i int) any {
			switch v := v.(*CertificateDates); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mpi_v1_files_proto_msgTypes[15].Exporter = func(v any, i int) any {
