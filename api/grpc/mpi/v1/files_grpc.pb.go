...
func (UnimplementedFileServiceServer) UpdateOverview(context.Context, *UpdateOverviewRequest) (*UpdateOverviewResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateOverview not implemented")
}
...
func (UnimplementedFileServiceServer) UpdateFileStream(grpc.ClientStreamingServer[FileDataChunk, UpdateFileResponse]) error {
	return status.Error(codes.Unimplemented, "method UpdateFileStream not implemented")
}
