...
func (m *APIActionRequest) GetAction() isAPIActionRequest_Action {
	if m != nil {
		return m.Action
	}
	return nil
...
func (x *APIActionRequest) GetNginxPlusAction() *NGINXPlusAction {
	if x, ok := x.GetAction().(*APIActionRequest_NginxPlusAction); ok {
...
func (m *NGINXPlusAction) GetAction() isNGINXPlusAction_Action {
	if m != nil {
		return m.Action
	}
	return nil
...
func (x *NGINXPlusAction) GetUpdateHttpUpstreamServers() *UpdateHTTPUpstreamServers {
	if x, ok := x.GetAction().(*NGINXPlusAction_UpdateHttpUpstreamServers); ok {
...
func (x *NGINXPlusAction) GetGetHttpUpstreamServers() *GetHTTPUpstreamServers {
	if x, ok := x.GetAction().(*NGINXPlusAction_GetHttpUpstreamServers); ok {
