...
var file_mpi_v1_command_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x22, 0x94, 0x02, 0x0a, 0x0b, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66,
...
var file_mpi_v1_command_proto_goTypes = []interface{}{
	...
	(*CommandServer)(nil),                 // 13: mpi.v1.CommandServer
	(*MetricsServer)(nil),                 // 14: mpi.v1.MetricsServer
	(*FileServer)(nil),                    // 15: mpi.v1.FileServer
...
var file_mpi_v1_command_proto_depIdxs = []int32{
	...
	13, // 8: mpi.v1.AgentConfig.command:type_name -> mpi.v1.CommandServer
	14, // 9: mpi.v1.AgentConfig.metrics:type_name -> mpi.v1.MetricsServer
	15, // 10: mpi.v1.AgentConfig.file:type_name -> mpi.v1.FileServer
