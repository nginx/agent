...
var file_mpi_v1_command_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0x48, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x6e,
	0x66, 0x6f, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x5f,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69,
	0x6e, 0x65, 0x72, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x22, 0x87, 0x01, 0x0a, 0x18,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x86, 0x01, 0x0a, 0x1c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	,
	...
	0x22, 0x13, 0x0a, 0x11, 0x44, 0x61, 0x74, 0x61, 0x50, 0x6c, 0x61, 0x6e, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x18, 0x0a, 0x16, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d,
...
var file_mpi_v1_command_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_mpi_v1_command_proto_goTypes = []interface{}{
	...
	(*InstanceAction)(nil),                // 16: mpi.v1.InstanceAction
	(*AgentConfig)(nil),                   // 17: mpi.v1.AgentConfig
	(*NGINXConfig)(nil),                   // 18: mpi.v1.NGINXConfig
	(*NGINXPlusConfig)(nil),               // 19: mpi.v1.NGINXPlusConfig
	(*CommandServer)(nil),                 // 20: mpi.v1.CommandServer
	(*MetricsServer)(nil),                 // 21: mpi.v1.MetricsServer
	(*FileServer)(nil),                    // 22: mpi.v1.FileServer
	(*MessageMeta)(nil),                   // 23: mpi.v1.MessageMeta
	(*CommandResponse)(nil),               // 24: mpi.v1.CommandResponse
	(*structpb.Struct)(nil),               // 25: google.protobuf.Struct
}
var file_mpi_v1_command_proto_depIdxs = []int32{
	23, // 0: mpi.v1.CreateConnectionRequest.message_meta:type_name -> mpi.v1.MessageMeta
	...
	24, // 6: mpi.v1.CreateConnectionResponse.response:type_name -> mpi.v1.CommandResponse
	17, // 7: mpi.v1.CreateConnectionResponse.agent_config:type_name -> mpi.v1.AgentConfig
	23, // 8: mpi.v1.UpdateDataPlaneStatusRequest.message_meta:type_name -> mpi.v1.MessageMeta
	13, // 9: mpi.v1.UpdateDataPlaneStatusRequest.instances:type_name -> mpi.v1.Instance
	...
	0,  // 12: mpi.v1.InstanceMeta.instance_type:type_name -> mpi.v1.InstanceMeta.InstanceType
	16, // 13: mpi.v1.InstanceConfig.actions:type_name -> mpi.v1.InstanceAction
	17, // 14: mpi.v1.InstanceConfig.agent_config:type_name -> mpi.v1.AgentConfig
	18, // 15: mpi.v1.InstanceConfig.nginx_config:type_name -> mpi.v1.NGINXConfig
	19, // 16: mpi.v1.InstanceConfig.nginx_plus_config:type_name -> mpi.v1.NGINXPlusConfig
	20, // 17: mpi.v1.AgentConfig.command:type_name -> mpi.v1.CommandServer
	21, // 18: mpi.v1.AgentConfig.metrics:type_name -> mpi.v1.MetricsServer
	22, // 19: mpi.v1.AgentConfig.file:type_name -> mpi.v1.FileServer
	25, // 20: mpi.v1.AgentConfig.labels:type_name -> google.protobuf.Struct
	1,  // 21: mpi.v1.CommandService.CreateConnection:input_type -> mpi.v1.CreateConnectionRequest
	7,  // 22: mpi.v1.CommandService.UpdateDataPlaneStatus:input_type -> mpi.v1.UpdateDataPlaneStatusRequest
	9,  // 23: mpi.v1.CommandService.UpdateDataPlaneHealth:input_type -> mpi.v1.UpdateDataPlaneHealthRequest
	11, // 24: mpi.v1.CommandService.Subscribe:input_type -> mpi.v1.DataPlaneResponse
	6,  // 25: mpi.v1.CommandService.CreateConnection:output_type -> mpi.v1.CreateConnectionResponse
	8,  // 26: mpi.v1.CommandService.UpdateDataPlaneStatus:output_type -> mpi.v1.UpdateDataPlaneStatusResponse
	10, // 27: mpi.v1.CommandService.UpdateDataPlaneHealth:output_type -> mpi.v1.UpdateDataPlaneHealthResponse
	12, // 28: mpi.v1.CommandService.Subscribe:output_type -> mpi.v1.ManagementPlaneRequest
