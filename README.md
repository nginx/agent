...
## Installing Go
NGINX Agent and the Mock Control Plane are written in Go. Go 1.20.4 or higher is required to build and run either application from the source code directory. You can [download Go from the official website](https://go.dev/dl/). 
