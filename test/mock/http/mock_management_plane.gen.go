...
func (siw *ServerInterfaceWrapper) GetInstanceFilesMetadata(c *gin.Context) {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("tenantId")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "tenantId", valueList[0], &TenantId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false})
		if err != nil {
...
func (siw *ServerInterfaceWrapper) GetInstanceFile(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "filePath", c.Param("filePath"), &filePath, runtime.BindStyledParameterOptions{Explode: false, Required: true})
	if err != nil {
