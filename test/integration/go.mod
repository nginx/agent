...
require (
	...
	github.com/nginx/agent/v2 v2.26.0
...
require (
	...
	github.com/distribution/distribution/v3 v3.0.0-20230608105614-4501a6e06d3b // indirect
	...
	github.com/nginxinc/nginx-go-crossplane v0.4.18 // indirect
...
replace (
	...
	// https://github.com/docker/buildx/blob/v0.10.5/go.mod#L174-L176
