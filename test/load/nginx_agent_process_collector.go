...
// Code is not autogenerated but excluding from linting as this is copied from OTel repo
...
func WithAgentExePath(exePath string) NginxAgentProcessOption {
	return func(cpc *agentProcessCollector) {
...
func (cp *agentProcessCollector) Start(params testbed.StartParams) error {
	cp.name = params.Name
...
func (cp *agentProcessCollector) Stop() (stopped bool, err error) {
...
func (cp *agentProcessCollector) GetProcessMon() *process.Process {
	return cp.processMon
}

func (cp *agentProcessCollector) fetchRAMUsage() {
...
func (cp *agentProcessCollector) fetchCPUUsage() {
...
func (cp *agentProcessCollector) checkAllowedResourceUsage() error {
...
func (cp *agentProcessCollector) GetTotalConsumption() *testbed.ResourceConsumption {
