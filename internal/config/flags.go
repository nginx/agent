...
const (
	...
	AuxiliaryRootKey                            = "auxiliary_command"
...
var (
	...
	AuxiliaryAuthKey          = pre(AuxiliaryRootKey) + "auth"
	AuxiliaryAuthTokenKey     = pre(AuxiliaryAuthKey) + "token"
	AuxiliaryAuthTokenPathKey = pre(AuxiliaryAuthKey) + "tokenpath"
	AuxiliaryTypeKey          = pre(AuxiliaryServerKey) + "type"
	AuxiliaryServerHostKey    = pre(AuxiliaryServerKey) + "host"
	AuxiliaryServerKey        = pre(AuxiliaryRootKey) + "server"
	AuxiliaryServerPortKey    = pre(AuxiliaryServerKey) + "port"
	AuxiliaryServerTypeKey    = pre(AuxiliaryServerKey) + "type"
	AuxiliaryTLSKey           = pre(AuxiliaryRootKey) + "tls"
	AuxiliaryTLSCaKey         = pre(AuxiliaryTLSKey) + "ca"
	AuxiliaryTLSCertKey       = pre(AuxiliaryTLSKey) + "cert"
	AuxiliaryTLSKeyKey        = pre(AuxiliaryTLSKey) + "key"
	AuxiliaryTLSServerNameKey = pre(AuxiliaryTLSKey) + "server_name"
	AuxiliaryTLSSkipVerifyKey = pre(AuxiliaryTLSKey) + "skip_verify"
