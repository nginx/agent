...
type FakeProcessWatcherOperator struct {
...
func (fake *FakeProcessWatcherOperator) Processes(arg1 context.Context) ([]*model.Process, error) {
...
func (fake *FakeProcessWatcherOperator) ProcessesCallCount() int {
	fake.processesMutex.RLock()
	defer fake.processesMutex.RUnlock()
	return len(fake.processesArgsForCall)
}

func (fake *FakeProcessWatcherOperator) ProcessesCalls(stub func(context.Context) ([]*model.Process, error)) {
	fake.processesMutex.Lock()
	defer fake.processesMutex.Unlock()
	fake.ProcessesStub = stub
}

func (fake *FakeProcessWatcherOperator) ProcessesArgsForCall(i int) context.Context {
	fake.processesMutex.RLock()
	defer fake.processesMutex.RUnlock()
...
func (fake *FakeProcessWatcherOperator) ProcessesReturns(result1 []*model.Process, result2 error) {
	fake.processesMutex.Lock()
	defer fake.processesMutex.Unlock()
...
func (fake *FakeProcessWatcherOperator) ProcessesReturnsOnCall(i int, result1 []*model.Process, result2 error) {
	fake.processesMutex.Lock()
	defer fake.processesMutex.Unlock()
	fake.ProcessesStub = nil
...
func (fake *FakeProcessWatcherOperator) Invocations() map[string][][]interface{} {
...
func (fake *FakeProcessWatcherOperator) recordInvocation(key string, args []interface{}) {
