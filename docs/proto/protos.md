...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| location | [string](#string) |  | A location to a file |
...
| external_data_source | [ExternalDataSource](#mpi-v1-ExternalDataSource) | optional | A external URL for the file source |
