...
type Event struct {
	...
	//	*Event_SecurityViolationEventRaw
...
type Event_SecurityViolationEventRaw struct {
	SecurityViolationEventRaw []byte `protobuf:"bytes,4,opt,name=SecurityViolationEventRaw,proto3,oneof" json:"security_violation_event_raw"`
}

func (*Event_ActivityEvent) isEvent_Data()             {}
func (*Event_SecurityViolationEvent) isEvent_Data()    {}
func (*Event_SecurityViolationEventRaw) isEvent_Data() {}
...
func (m *Event) GetSecurityViolationEventRaw() []byte {
	if x, ok := m.GetData().(*Event_SecurityViolationEventRaw); ok {
		return x.SecurityViolationEventRaw
	}
	return nil
}
...
func (*Event) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Event_SecurityViolationEventRaw)(nil),
	}
}
...
var fileDescriptor_2d17a9d3f0ddf27e = []byte{
	...
	,
}
...
func (m *Event_SecurityViolationEventRaw) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Event_SecurityViolationEventRaw) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SecurityViolationEventRaw != nil {
		i -= len(m.SecurityViolationEventRaw)
		copy(dAtA[i:], m.SecurityViolationEventRaw)
		i = encodeVarintEvent(dAtA, i, uint64(len(m.SecurityViolationEventRaw)))
		i--
		dAtA[i] = 0x22
	}
	return len(dAtA) - i, nil
...
func (m *Event_SecurityViolationEventRaw) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SecurityViolationEventRaw != nil {
		l = len(m.SecurityViolationEventRaw)
		n += 1 + l + sovEvent(uint64(l))
	}
	return n
}
...
func (m *Event) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecurityViolationEventRaw", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Data = &Event_SecurityViolationEventRaw{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvent(dAtA[iNdEx:])
