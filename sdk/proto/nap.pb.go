...
=======
=======
>>>>>>> aeb0dc74 (Create dedicated cache and upstream metrics reports)
=======
>>>>>>> b1c864fb (Create dedicated cache and upstream metrics reports)
=======
>>>>>>> 1accccec (Create dedicated cache and upstream metrics reports)
	if len(m.WafVersion) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintNap(dAtA, i, uint64(len(m.WafVersion)))
		i += copy(dAtA[i:], m.WafVersion)
<<<<<<< HEAD
<<<<<<< HEAD
<<<<<<< HEAD
>>>>>>> b0c49853 (Create dedicated cache and upstream metrics reports)
	}
	if len(m.AttackSignaturesVersion) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintNap(dAtA, i, uint64(len(m.AttackSignaturesVersion)))
		i += copy(dAtA[i:], m.AttackSignaturesVersion)
	}
	if len(m.ThreatCampaignsVersion) > 0 {
		dAtA[i] = 0x1a
		i++
...
=======
	if m.XXX_unrecognized != nil {
		i -= len(m.XXX_unrecognized)
		copy(dAtA[i:], m.XXX_unrecognized)
>>>>>>> 29a5bd11 (adds updated generated files from protobuf)
	}
	if m.Health != nil {
		{
			size, err := m.Health.MarshalToSizedBuffer(dAtA[:i])
...
=======
	if m.XXX_unrecognized != nil {
		i -= len(m.XXX_unrecognized)
		copy(dAtA[i:], m.XXX_unrecognized)
>>>>>>> 4e412375 (adds updated generated files from protobuf)
	}
	if m.Health != nil {
		{
			size, err := m.Health.MarshalToSizedBuffer(dAtA[:i])
...
=======
	if m.XXX_unrecognized != nil {
		i -= len(m.XXX_unrecognized)
		copy(dAtA[i:], m.XXX_unrecognized)
>>>>>>> 506308d4 (adds updated generated files from protobuf)
	}
	if m.Health != nil {
		{
			size, err := m.Health.MarshalToSizedBuffer(dAtA[:i])
