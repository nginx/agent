...
type DataplaneStatus struct {
	...
	AgentActivityStatus      []*AgentActivityStatus      `protobuf:"bytes,7,rep,name=agent_activity_status,json=agentActivityStatus,proto3" json:"agent_activity_status"`
	XXX_NoUnkeyedLiteral     struct{}                    `json:"-"`
	XXX_unrecognized         []byte                      `json:"-"`
	XXX_sizecache            int32                       `json:"-"`
}
...
type NginxConfigStatus struct {
	...
	Status               Status   `protobuf:"varint,2,opt,name=status,proto3,enum=f5.nginx.agent.sdk.Status" json:"status"`
	Message              string   `protobuf:"bytes,3,opt,name=message,proto3" json:"message"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *NginxConfigStatus) GetStatus() Status {
	if m != nil {
		return m.Status
	}
...
func init() {
	proto.RegisterEnum("f5.nginx.agent.sdk.Status", Status_name, Status_value)
...
var fileDescriptor_213c0bb044472049 = []byte{
	...
	,
}
