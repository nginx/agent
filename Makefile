...
MOCK_MANAGEMENT_PLANE_CONFIG_DIRECTORY ?= /Users/d.hurley/go/src/github.com/nginx/agent/test/config
MOCK_MANAGEMENT_PLANE_LOG_LEVEL ?= INFO
MOCK_MANAGEMENT_PLANE_GRPC_ADDRESS ?= 127.0.0.1:8981
MOCK_MANAGEMENT_PLANE_API_ADDRESS ?= 127.0.0.1:8982
